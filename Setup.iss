...
;SignTool=MsSign $f
;Encryption=yes
AppID={{E77FBA42-38D8-4D9E-9844-B9C1126996B0}
AppName=Touptek AFW ASCOM Driver by photon
AppVersion={#myAppVersion}
AppVerName="Touptek AFW ASCOM Driver by photon {#myAppVersion}"
...
OutputDir="."
OutputBaseFilename="Touptek AFW ASCOM Driver by photon Setup {#myAppVersion}"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Filterwheel\TouptekAFWphoton"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Filterwheel\TouptekAFWphoton"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "C:\git\TouptekAFW\bin\Release\ASCOM.photonTouptekAFW.exe"; DestDir: "{app}"
Source: "C:\git\TouptekAFW\bin\Release\toupcam.dll"; DestDir: "{app}"

; Only if driver is .NET
[Run]

; Only for .NET local-server drivers
Filename: "{app}\ASCOM.photonTouptekAFW.exe"; Parameters: "/register"
...
; Only for .NET local-server drivers
Filename: "{app}\ASCOM.photonTouptekAFW.exe"; Parameters: "/unregister"
