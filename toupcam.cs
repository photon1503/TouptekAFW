...
public class Toupcam : IDisposable
{
    ...
    public static uint MAKEFOURCC(uint a, uint b, uint c, uint d)
    {
    ...
    /* get the version of this dll/so, which is: 59.28482.20250512 */
    ...
    */
    ...
    private static bool Ptr2LensInfo(ref LensInfo pInfo, IntPtr p)
    {
        IntPtr saveptr = p;
