...
#define myAppVersion "7.0.1.0"
[Setup]
;SignTool=MsSign $f
;Encryption=yes
AppID={{45CEA8DE-05AD-4B5B-A923-BA841F3DEBAF}
AppName=Touptek AFW ASCOM Driver #2 by photon
AppVersion={#myAppVersion}
AppVerName="Touptek AFW ASCOM Driver #2 by photon {#myAppVersion}"
...
OutputDir="."
OutputBaseFilename="Touptek AFW ASCOM Driver #2 by photon Setup {#myAppVersion}"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Filterwheel\TouptekAFWphoton2"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Filterwheel\TouptekAFWphoton2"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "C:\git\TouptekAFW\AFW2\bin\Release\ASCOM.photonTouptekAFW2.exe"; DestDir: "{app}"
Source: "C:\git\TouptekAFW\AFW2\bin\Release\toupcam.dll"; DestDir: "{app}"

; Only if driver is .NET
[Run]

; Only for .NET local-server drivers
Filename: "{app}\ASCOM.photonTouptekAFW2.exe"; Parameters: "/register"
...
; Only for .NET local-server drivers
Filename: "{app}\ASCOM.photonTouptekAFW2.exe"; Parameters: "/unregister"
