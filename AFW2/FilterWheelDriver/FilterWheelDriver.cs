...
namespace ASCOM.photonTouptekAFW2.FilterWheel
{
    ...
    [ProgId("ASCOM.photonTouptekAFW2.FilterWheel")]
    [ServedClassName("Touptek AFW #2 by photon")] // Driver description that appears in the Chooser, customise as required
    ...
    public class FilterWheel : ReferenceCountedObjectBase, IFilterWheelV3, IDisposable
    {
        ...
        public FilterWheel()
        {
            try
            {
                ...
                tl = new TraceLogger("", "photonTouptekAFW2.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
                SetTraceState();
